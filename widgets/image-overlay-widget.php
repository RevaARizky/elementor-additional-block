		...
		<section class="custom-block image-overlay-block">
			...
			<div class="md:hidden block">
				<div class="text-wrapper">
					<p class="text-white text-phara">
						<?= $settings['description'] ?>
					</p>
				</div>
			</div>

			<div class="image-wrapper relative lg:pt-[420px] pt-[100%]">
				<div class="overlay-button-trigger absolute hidden md:block bottom-4 right-4 cursor-pointer z-20">
				...
				<div class="overlay-content-wrapper absolute -inset-[1px] overflow-y-auto px-6 lg:py-8 py-4 lg:px-12 z-10">
